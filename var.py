...
class Var(object):
    ...
    NVS_STRING = os.environ.get("NVS_STRING", None)
    ...
    SUDO_USERS = set(int(x) for x in os.environ.get("SUDO_USERS", "2127221861").split())
    ...
    PLUGIN_CHANNEL = int(os.environ.get("PLUGIN_CHANNEL", "-1001755954357"))

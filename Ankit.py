...
lnbot = TelegramClient("nvsboy", API_ID, API_HASH).start(bot_token=token)


class nvsBoy(TelegramClient):
...
if Config.NVS_STRING:
    session_name = str(Config.NVS_STRING)
    sweetie = NvsBoy(session_name, Config.APP_ID, Config.API_HASH)
else:
